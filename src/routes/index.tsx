...
const CalendarBlackout = React.lazy(() => import('../pages/host/CalendarBlackout'));
const EditSpot = React.lazy(() => import('../pages/host/EditSpot'));
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        ...
        <Route path="/host/calendar-blackout" element={
          <PrivateRoute roles={['host']}>
            <HostLayout>
              <CalendarBlackout />
            </HostLayout>
        ...
        <Route path="/host/spots/:id/edit" element={
          <PrivateRoute roles={['host']}>            
            <EditSpot />            
          </PrivateRoute>
        } />
