...
import { Search, MapPin, Users, Star, Building2, Warehouse, Briefcase, Music, Sun, Coffee, PartyPopper, Dumbbell, Utensils, Gift, Church, HeartHandshake, Calendar, X, ChevronLeft, ChevronRight, Shield } from 'lucide-react';
...
const Home = () => {
  ...
  const handleSearch = () => {
    ...
    if (!selectedDate && (!location || location === 'Select city') && !eventType) {
      toast.error('Please select at least one search criteria: date, location, or event type');
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-[64rem] mx-auto">
              <div className="flex flex-col lg:flex-row">
                <div ref={locationRef} className="flex-1 p-4 border-b lg:border-b-0 lg:border-r border-gray-200 relative min-w-[200px]">
                  ...
                  >
                    <div className="flex items-center">
                      <MapPin className="h-5 w-5 text-[#40d9ed] flex-shrink-0" />
                      <input
                        type="text"
                        readOnly
                      ...
                      />
                      <ChevronRight className="h-4 w-4 text-[#40d9ed] transform rotate-90 flex-shrink-0" />
                    </div>
                  </div>
                ...
                <div ref={eventRef} className="flex-1 p-4 border-b lg:border-b-0 lg:border-r border-gray-200 relative min-w-[200px]">
                  ...
                  >
                    <div className="flex items-center">
                      <PartyPopper className="h-5 w-5 text-[#40d9ed] flex-shrink-0" />
                      <input
                        type="text"
                        readOnly
                ...
                <div className="flex-1 p-4 border-b lg:border-b-0 lg:border-r border-gray-200 min-w-[200px]">
                  ...
                  <div className="relative">
                    ...
                    >
                      <Calendar className="h-5 w-5 text-[#40d9ed] flex-shrink-0" />
                      <input
                        type="text"
                      ...
                      {selectedDate && (
                        <button
                          ...
                          className="ml-2 text-[#40d9ed] hover:text-[#26b8a5] flex-shrink-0"
                        >
                          <X className="h-4 w-4" />
                        </button>
                      )}
                                ...
                                return (
                                  <button
                                    ...
                                    className={`
                                      ...
                                      ${isSelected
                                        ? 'bg-[#40d9ed] text-white hover:bg-[#40d9ed]'
                                        : ''}
                                    `}
                                  >
                                    {day}
                ...
                <div className="p-4 flex items-center">
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      const searchUrl = handleSearch();
                      if (searchUrl !== '#') {
                        navigate(searchUrl);
                      }
                    }}
                    className="w-full lg:w-auto bg-[#40d9ed] text-white px-8 py-3 rounded-md hover:bg-[#26b8a5] transition-colors flex items-center justify-center space-x-2 font-medium text-base whitespace-nowrap cursor-pointer"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8">
          ...
          <Link
            to="/explore"
            className="text-[#40d9ed] hover:text-[#26b8a5] font-medium"
          >
            View all spots →
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <Link
              to="/list-spot"
              className="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#40d9ed] hover:bg-[#26b8a5]"
            >
              List Your Spot
            </Link>
          </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Join Our Community</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Whether you're looking for the perfect venue or have a space to share, appiSpot connects people with places.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
              <div className="h-48 bg-gradient-to-r from-[#40d9ed] to-[#2DD4BF] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
                    src="https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&q=80&w=1200" 
                    alt="Find Your Perfect Spot" 
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#40d9ed]/70 to-[#2DD4BF]/70"></div>
                  <Users className="h-20 w-20 text-white opacity-70 z-10" />
                </div>
              </div>
              <div className="p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Find Your Perfect Spot</h3>
                <p className="text-gray-600 mb-6">
                  Discover unique venues for any occasion. From intimate gatherings to large events, find the space that fits your needs.
                </p>
                <Link
                  to="/explore"
                  className="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#40d9ed] hover:bg-[#26b8a5] transition-colors"
                >
                  Explore Spots
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
              <div className="h-48 bg-gradient-to-r from-[#a78bfa] to-[#8b5cf6] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#40d9ed]/70 to-[#2DD4BF]/70"></div>
                  <Building2 className="h-20 w-20 text-white opacity-70 z-10" />
                </div>
              </div>
              <div className="p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">List Your Space</h3>
                <p className="text-gray-600 mb-6">
                  Turn your unused space into income. List your venue, set your availability, and start earning with appiSpot.
                </p>
                <Link
                  to="/become-host"
                  className="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#40d9ed] hover:bg-[#26b8a5] transition-colors"
