...
const mockPayouts = [
  ...
  },
  {
    ...
    bookings: 8,
    method: 'Bank Account',
    accountInfo: 'Bank of America **** 5678'
  },
  {
    id: 'PO003',
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs font-medium text-yellow-600">All payouts require manual bank transfers with full bank details</p>
              </div>
            </div>
          </div>
        )}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {mockPayouts.map((payout) => (
                  <tr key={payout.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap border-l-2 border-yellow-200 bg-yellow-50">
                      <div className="text-sm font-medium text-gray-900">Bank Account</div>
                      <div className="text-sm text-gray-900">Chase Bank 1234</div>
                      <div className="text-sm text-gray-900">Routing: 123456789</div>
                      <div className="text-sm text-gray-900">Account: 987654321</div>
                      <div className="text-xs font-medium text-yellow-600 mt-1">MANUAL TRANSFER REQUIRED</div>
                    </td>
