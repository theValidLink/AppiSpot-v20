...
const ListSpot = () => {
  ...
  const handleSubmit = async () => {
    ...
    toast.success('Your spot has been listed successfully!');
    navigate('/host/spots');
  };
      ...
      <header className="bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="text-center">
              <h1 className="text-lg font-semibold text-gray-900">List your spot</h1>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-10">
        <div className="max-w-3xl mx-auto flex justify-between">
          ...
          {currentStep < 5 ? (
            <button
              onClick={nextStep}
              className="px-6 py-3 bg-[#40d9ed] text-white rounded-lg hover:bg-[#26b8a5] transition-colors"
            >
              Next
            </button>
          ) : (
