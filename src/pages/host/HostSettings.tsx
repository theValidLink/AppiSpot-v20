...
import { User, Mail, Phone, MapPin, Lock, CreditCard, Bell, Shield, AlertCircle, Plus, Trash2, Camera } from 'lucide-react';
          ...
          <div className="flex items-center space-x-6">
            <div className="relative">
              {mockUser.avatar ? (
                ...
                <div className="h-24 w-24 rounded-full bg-[#40d9ed] flex items-center justify-center">
              ...
              <label
                ...
                className="absolute bottom-0 right-0 p-2 bg-white rounded-full shadow-md hover:bg-gray-50 cursor-pointer"
              >
            ...
            <div>
              <h3 className="text-base font-medium text-gray-900">Change Profile Picture</h3>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {bank.accountName} • Account {bank.accountNumber}
                    </p>
                    <p className="text-sm text-gray-500">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    onClick={() => setShowDeleteBank(bank.id)}
                    className="text-red-600 hover:text-red-700"
                  >
                    <Trash2 className="h-4 w-4" />
                  </button>
      ...
      {showDeleteBank && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            ...
            <div className="flex justify-end space-x-3">
              <button
                onClick={() => setShowDeleteBank(null)}
                className="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md"
              >
                Cancel
              </button>
              <button
                onClick={() => handleDeleteBank(showDeleteBank)}
                className="px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-md"
              >
                Remove
              </button>
