  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const spotData = {
        ...
        squareFootage: parseInt(formData.square_footage),
      ...
      const data = await createSpot(spotData);
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#40d9ed] focus:ring-[#40d9ed] sm:text-sm"
          ...
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="block w-full pl-10 pr-12 sm:text-sm border-gray-300 rounded-md focus:ring-[#40d9ed] focus:border-[#40d9ed]"
                placeholder="0"
              />
            ...
            {Object.entries(formData.features).map(([feature, enabled]) => (
              <button
                ...
                className={`p-4 rounded-lg border ${
                  enabled
                    ? 'bg-[#40d9ed]/10 border-[#40d9ed] text-[#40d9ed]'
                    : 'bg-white border-gray-300 text-gray-700'
                } hover:bg-[#40d9ed]/10 transition-colors duration-200`}
              >
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#40d9ed] text-white rounded-md hover:bg-[#26b8a5]"
              >
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {formData.amenities.map((amenity, index) => (
                <span
                  key={index}
                  className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#40d9ed]/10 text-[#40d9ed]"
                >
                  {amenity}
                  <button
                    type="button"
      ...
      <div>
        <button
          type="submit"
          disabled={loading}
          className="w-full flex justify-center items-center px-4 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#40d9ed] hover:bg-[#26b8a5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#40d9ed] disabled:opacity-50"
        >
