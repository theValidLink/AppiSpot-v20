...
import { LogOut, Home, Users, UserCircle, Calendar, DollarSign, Wallet, Menu, X, RefreshCcw, Building2, CheckSquare, UserCog, MessageSquare, Bell } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      icon: UserCircle, 
      path: '/admin/guests',
      description: 'Manage guest accounts'
    },
    { 
      title: 'Bookings', 
      icon: Calendar, 
    ...
    { 
      ...
      icon: DollarSign, 
      path: '/admin/revenue',
      description: 'Track platform revenue'
    },
    { 
      title: 'Payouts', 
      icon: Wallet, 
      path: '/admin/payouts',
      description: 'Manage host payouts'
    },
    { 
      title: 'Refunds', 
      icon: RefreshCcw, 
      path: '/admin/refunds',
      description: 'Process refund and cancellation requests'
    },
    { 
      title: 'Spots', 
      icon: Building2, 
      path: '/admin/spots',
      description: 'Manage venue listings'
    },
    { 
      title: 'Approvals', 
      icon: CheckSquare, 
            ...
            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="text-sm text-[#40d9ed] hover:text-[#26b8a5]"
                >
                  View All
                </button>
                <button
              ...
              {messages.map((message) => (
                <div
                  ...
                  className={`p-4 rounded-lg ${
                    message.unread ? 'bg-[#40d9ed]/5' : 'bg-white border border-gray-200'
                  }`}
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="h-10 w-10 rounded-full bg-[#40d9ed] flex items-center justify-center">
                    ...
                    {message.unread && (
                      <span className="h-2 w-2 bg-[#40d9ed] rounded-full"></span>
                    )}
                  </div>
