...
import { LogOut, Home, Calendar, Building2, DollarSign, Ban, MessageSquare, Settings, Menu, X, CalendarOff } from 'lucide-react';
...
const menuItems = [
  ...
  { 
    title: 'Calendar Blackout', 
    icon: CalendarOff, 
    path: '/host/calendar-blackout',
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-end space-x-2">
                    <button className="px-3 py-1 text-sm text-[#40d9ed] hover:bg-[#40d9ed]/10 rounded">
                      Reply
                    </button>
