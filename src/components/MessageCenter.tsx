            ...
            <div className="flex-1 overflow-y-auto divide-y divide-gray-200">
              {mockMessages.map((message) => (
                <div
                  ...
                  className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors ${message.unread ? 'bg-[#40d9ed]/5' : ''}`}
                >
                ...
                <form onSubmit={handleReply} className="space-y-2">
                  <div className="flex-1">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-lg border-gray-300 shadow-sm focus:ring-[#40d9ed] focus:border-[#40d9ed] resize-none"
                  ...
                  <div className="flex justify-end">
                    <button
                      type="submit"
                      className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#40d9ed] hover:bg-[#26b8a5]"
                    >
